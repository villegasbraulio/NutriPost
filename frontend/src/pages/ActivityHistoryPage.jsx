      ...
      <section className="glass-panel rounded-[32px] p-6">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-textMuted">Filter by date range and category.</p>
          </div>
        </div>
          ...
          <div key={label} className="grid gap-4 lg:grid-cols-[160px_1fr]">
            ...
            <div className="space-y-4 border-l border-white/10 pl-6">
              {items.map((item) => (
                ...
                >
                  <div className="absolute -left-[34px] top-8 h-4 w-4 rounded-full border-4 border-background bg-primary" />
